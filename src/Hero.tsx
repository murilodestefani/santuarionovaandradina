    ...
    >
      <div className="container flex flex-col p-4 sm:p-0">
        <div className="flex flex-col gap-2 xl:max-w-xl">
          <h1 className="text-center text-4xl font-bold text-slate-50 sm:text-4xl xl:text-start xl:text-6xl">
          ...
          <div className="flex justify-center gap-2 xl:justify-start">
            ...
            <Button
              href="#"
              className="self-center rounded-md bg-slate-50 px-12 py-5 font-semibold text-penn-red-900"
            >
              Últimos Eventos
            </Button>
          </div>
