  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center w-full">
        ...
        <Image className="hidden md:block" radius="none" src="/assets/img/instagram/04.png"/>
        <Image className="hidden lg:block" radius="none" src="/assets/img/instagram/05.png"/>
        <Image className="hidden xl:block" radius="none" src="/assets/img/instagram/06.png"/>
      </div>
    </section>
  );
}
